...
function normalizeSequenceItems($rawSequence): array {
...
function normalizeNowForTimezone($now, ?string $timezone = null): DateTimeImmutable {
...
function timeInRange(string $start, string $stop, $now = null, ?string $timezone = null): bool {
    $start = trim($start);
    $stop = trim($stop);
...
function isWithinOperatingSchedule(array $config, $now = null): bool {
...
function resolveActiveSequenceSlot(array $sequenceItems, $now = null, ?string $timezone = null): ?array {
...
function resolveNextSequenceSlot(array $sequenceItems, $now = null, ?string $timezone = null): ?array {
...
function resolveSequenceRuntimeData(array $selectedPreset, array $sequenceItems, array $presets, array $config, $now = null): array {
